...
@Component({
  selector: 'app-products-directives-assignment-six',
  templateUrl: './products-directives-assignment-six.component.html',
  styleUrls: ['./products-directives-assignment-six.component.css']
})
export class ProductsDirectivesAssignmentSixComponent {
  products =[
